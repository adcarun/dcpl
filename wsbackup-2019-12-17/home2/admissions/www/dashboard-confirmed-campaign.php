...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VI Schools | Confirmed Dashboard (By Campaign)</title>
            ...
            <div id="inner-container">
                ...
                <form name="frm" method="post">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Confirmed Dashboard (By Campaign)</a></li>
                    </ul>
                    <!-- END Navigation info -->
                    ...
                    <?php /*?><h3 class="page-header">Manage Enquiry</h3>
                        ...
                        <!-- Mini Price Tables -->
                    <h2 class="page-header text-center">Confirmed Dashboard (By Campaign)</h2>
					<?php
                        ...
                        <?php
                           ...
                           /* if($_SESSION['objLogin']->AccessLevel=="College Principal" || $_SESSION['objLogin']->AccessLevel=="Collage Executive"){
							...
							//	$ArrProducts=$objProduct->getDatalimited("*"," WHERE Name = '".$_SESSION['objLogin']->Name."' order by Name asc ",false);
								$ArrProducts=$objSource->getDatalimited("*"," WHERE Name = '".$_SESSION['objLogin']->Name."' order by Name asc ",false);
							}else{*/
                            //    $ArrProducts=$objProduct->getDatalimited("*"," order by Name asc ",false);
                                $ArrProducts=$objSource->getDatalimited("*"," Where DisplayStatus='Active' order by Title asc ",false);
							//}	
                            //}
                            $i=1;
                                ...
                                ?>
                                    <div class="plan">
                                        <h3 class="plan-header">All Campaigns</h3>
                                        <ul class="icons-ul">
                                            <?php
											   ...
											   $cnt=1;
                                                foreach($ArrProducts as $Products)
                                                {
                                                    ...
                                                    ?>
                                                        <li>
                                                            <a href="javascript:ViewEnquiryDetailsSource('<?=$Products['Id']?>','<?=$status?>','./manage-enquiry.php?I=4');" data-toggle="tooltip" title="Click to view details">
                                                                <span class="campaignBadge badge badge-<?=$class?>">
                                                                    <?php
                                                                    if($_SESSION['objLogin']->AccessLevel=="Executive"){
                                                                        
                                                                           $ArrCnt=$objTotalCnt->getDatalimited("COUNT(EnqId) AS cnt"," WHERE Status = '26' and SourceId = ".$Products['Id'],false);
                                                                    }
                                                                    else
                                                                    {
                                                                        $ArrCnt=$objTotalCnt->getDatalimited("COUNT(EnqId) AS cnt"," WHERE Status = '26' AND SourceId = ".$Products['Id'],false);    
                                                            ...
                                                            <span class="campaignName"><?=$Products['Title']?></span>
