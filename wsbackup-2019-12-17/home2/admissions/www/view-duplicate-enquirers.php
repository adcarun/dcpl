        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <form name="frm" method="post">
                    ...
                    <?php  
						$cond=" Where EnqId != 0 and Email = '".$_GET['Email']."' "; 
                    ...
                    <h3 class="page-header">View Enquiry</h3>
                        ...
                        <span style="float:right"><a href="./duplicate-enquirers.php?I=20" class="btn label-info" style="margin-top:10px;">Back</a></span>
                                    ...
                                    <tr class="<?=$class?>">
										...
										<td class="">
                                            <div class="btn-group">
                                            	...
                                            	<!--<a href="javascript:EditRecord('<?= $arrData[$key]['EnqId'] ?>', './edit-enquiry.php?I=4');" data-toggle="tooltip" title="Edit Enquiry" class="btn btn-xs btn-success"><i class="icon-pencil"></i></a>-->
                                                <?php if($_SESSION['objLogin']->AccessLevel=="Admin"){ ?>
