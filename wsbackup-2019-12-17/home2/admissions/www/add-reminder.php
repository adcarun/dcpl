        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="Reminder" onReset="this.Name.focus();" action="add-reminder-action.php" enctype="multipart/form-data" class="form-horizontal form-box">
                        ...
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
								...
								Here administrator can Add / Edit Reminder.
								<?php }else{ ?>
									Here Executive can Add / Edit Reminder.
								<?php } ?>
								</small></li>
                        ...
                        <div class="form-box-content">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" name="EnquiryId" id="EnquiryId">
                                        ...
                                        <?php
                                            ...
                                            $arrEnquiry=$objEnquiry->getDatalimited("Id,Name"," order by Id desc ",false);
                                            foreach($arrEnquiry as $enquiry)
                                            {
											//	print_r($enquiry);
                                                ?>
                                                    <option value="<?php echo $enquiry['Id']; ?>" <?php if($arrData[0]['EnquiryId']==$enquiry['Id']){ ?> selected <?php } ?>><?php echo $enquiry['Name']; ?></option>
                                                <?php	
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="Title" id="Title" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Title'])));?>" maxlength="50" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date input-datepicker " data-date="<?=date('d/m/Y');?>" data-date-format="yyyy-mm-dd">
                                        ...
                                        <input type="text" id="TransactionDateFrom" name="ReminderDate" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ReminderDate'])));?>" class="form-control" readonly style="width:110px;">
                                    </div>
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                	<input class="form-control" type="text" id="time" name="ReminderTime" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ReminderTime'])));?>" />
                                </div>
                            </div>
