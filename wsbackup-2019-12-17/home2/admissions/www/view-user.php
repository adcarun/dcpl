...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script src="./js/ajax-check.js"></script>	
        ...
        <title>VI Schools | View User</title>
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">View User</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="User" onReset="this.Name.focus();" action="" enctype="multipart/form-data" class="form-horizontal form-box">
                    	<input type="hidden" name="Id" value="<?= $_POST['id'] ?>" />
                        <h4 class="form-box-header">View User</h4>
                        
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can View User.</small></li>
                            </ul>
                        </h5>
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                	<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['AccessLevel'])));?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Status :</label>
                                <div class="col-md-3">
                                	<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['DisplayStatus'])));?>
                                </div>
                            </div>
