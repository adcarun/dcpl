...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VI Schools | Manage Previous Follow Up</title>
                ...
                <form name="frm" method="post">
                    ...
                    <?php 
						if($_SESSION['objLogin']->AccessLevel=="Admin"){
							$cond=" Where Id != 0 and TodaysUpdate!='' and NextUpdateDate < '".date('Y-m-d')."' and EnqId IN(select Id from tbl_enquiry)"; 
						}
						else
						{
							$cond=" Where Id != 0 and TodaysUpdate!='' and NextUpdateDate < '".date('Y-m-d')."' and UserId = ".$_SESSION['objLogin']->Id." and EnqId IN(select Id from tbl_enquiry)"; 	
						}
						...
						set_management("tbl_follow_up", $cond, "NextUpdateDate", "DESC", 15);
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Manage Previous Follow Up</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Row Classes -->
                    <h3 class="page-header">Manage Previous Follow Up</h3>
                    	<h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
								...
								Here administrator can view Manage Previous Follow Up.
								<?php }else{ ?>
									Here Executive can view Manage Previous Follow Up.
								<?php } ?>
								</small></li>
                            </ul>
                        </h5>
					...
					<div class="row" style="padding:0 0 10px 0">
                        ...
                        <div class="col-md-4">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-success" type="button" onClick="clearSearch(this.form, ['srch_AssignedTo','TransactionDateFrom','TransactionDateTo']);">Show all</button>
                            </div>
                        </div>
                     </div>     
                  </div>
                        ...
                        <tbody>
							...
							?>
                                    <tr class="<?=$class?>">
										...
										<td class=""><a href="javascript:EditRecord('<?= $arrEnquiry[0]['Id'] ?>', './view-enquiry.php?I=4&ref=prev');" data-toggle="tooltip" title="View Enquiry" ><?=$arrEnquiry[0]['Name'];?></a></td>
                                        ...
                                        <td class="">
                                            <div class="btn-group">
                                            	<a href="javascript:EditRecord('<?= $arrData[$key]['EnqId'] ?>', './enquiry-follow.php?I=13&ref=prev');" data-toggle="tooltip" title="Follow up" class="btn btn-xs btn-primary"><i class="icon-book"></i></a>
												<?php if($_SESSION['objLogin']->AccessLevel=="Admin"){ ?>
												<a href="javascript:EditRecord('<?= $arrData[$key]['Id'] ?>', './edit-followup.php?I=13&ref=prev');" data-toggle="tooltip" title="Edit Follow up" class="btn btn-xs btn-success"><i class="icon-pencil"></i></a>
												<?php } ?>
                                            </div>
                                        </td>
                                        <?php //} ?>
