<?php
	if($_POST['id']=='')
	{
		header("location:todays-reminder.php?I=6");
		exit();
	}
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script src="./js/ajax-check.js"></script>	
 	<script>
        ...
        <title>VI Schools | View Reminder</title>
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">View Reminder</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="Reminder" onReset="this.Name.focus();" action="" enctype="multipart/form-data" class="form-horizontal form-box">
                    	<input type="hidden" name="Id" value="<?= $_POST['id'] ?>" />
                        <h4 class="form-box-header">View Reminder</h4>
                        ...
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
								...
								Here administrator can View Reminder.
								<?php }else{ ?>
								Here Executive can View Reminder.
								<?php } ?>
								</small></li>
                            </ul>
                        </h5>
                        <div class="form-box-content">
							...
							<div class="form-group">
                                ...
                                <div class="col-md-8">
                                	<?php echo date('j M Y',strtotime($arrData[0]['ReminderDate'])); ?>
                                </div>
                            </div>
							 <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Date :</label>
                                <div class="col-md-8">
                                	<?php echo date('h:i a',strtotime($arrData[0]['ReminderTime']));?>
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <?php
											$resultEnq = mysql_query("select Id,Name from tbl_enquiry where Id=".$arrData[0]['EnquiryId']);
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Title'])));?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Description :</label>
                                <div class="col-md-4">
                                	<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Description'])));?>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                	<?php
										...
										{
											?>
                                            	<button type="button" class="btn btn-danger" onClick="document.location='./todays-reminder.php?I=6'" title="Go back to Manage Reminder" data-toggle="tooltip"><i class="icon-remove"></i> Go back to Manage Reminder</button>
                                            <?php
										}
										else
										{
