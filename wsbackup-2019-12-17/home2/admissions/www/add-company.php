...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  	...
  	$(document).ready(function() {
		...
		rules: { 
			CName:
			{
				...
				CompanyName:true,
				remote:{
					url:"ajax-check-company-name.php",
					type:"post",
					data:{
					CName:function(){
							return $("#CName").val();
			...
			messages: {
				CName: {
					remote : "Company name already exists, Please enter another on"
				},
				CPhoneNo:{
	...
	{ 
        ...
        <title>VI Schools | Add / Edit Company</title>
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Add / Edit Company</a></li>
                    </ul>
                    <!-- END Navigation info -->
                    ...
                    <form name="frm" method="post" id="Company" onReset="this.Name.focus();" action="add-company-action.php" enctype="multipart/form-data" class="form-horizontal form-box">
                        ...
                        <h4 class="form-box-header">Add / Edit Company</h4>
                        
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can Add / Edit Company.</small></li>
                        ...
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                	<input type="text" id="CName" name="CName" maxlength="50" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['CName'])));?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                	<textarea name="CAddress" id="CAddress" maxlength="250" class="form-control"><?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['CAddress'])));?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Phone No :</label>
                                <div class="col-md-4">
                                	<input type="text" id="CPhoneNo" name="CPhoneNo" maxlength="11" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['CPhoneNo'])));?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Status :</label>
                                <div class="col-md-2">
                                	<select name="CDisplayStatus" id="CDisplayStatus" class="form-control">
                                    	<option value="">Select</option>
                                        <option value="Active" <?php if(htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['CDisplayStatus']))) == 'Active') echo "selected"; ?>>Active</option>
                                        <option value="Deactive" <?php if(htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['CDisplayStatus']))) == 'Deactive') echo "selected"; ?>>Deactive</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    <button type="submit" class="btn btn-success" title="Save All Data" data-toggle="tooltip" <?php if(isset($_POST['id'])){ ?> onClick="removeValidationRemote('CName');"  <?php } ?>><i class="icon-save"></i> Submit</button>
                                    <?php if ($_POST['id']=="") { ?>
