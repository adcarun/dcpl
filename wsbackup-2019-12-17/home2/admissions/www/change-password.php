<?php
	...
	$obj=new GenericClass("cjd_title");
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script src="./js/ajax-check.js"></script>	
 	<script>
        ...
        <title>VI Schools | Change Password</title>
        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="ChangePasswordForm" onReset="this.OldPassword.focus();" action="change-password-action.php" enctype="multipart/form-data" class="form-horizontal form-box">
                    	<h4 class="form-box-header">Change Password</h4>
                        ...
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">User Name :</label>
                                <div class="col-md-3">
                                	<?php echo ucwords($_SESSION['objLogin']->Name); ?>
                                    <input type="hidden" name="UserName" value="<?=$_SESSION['objLogin']->Name?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Old Password <span style="color:#F00;">*</span> :</label>
                                <div class="col-md-3">
                                    <input type="password" name="OldPassword" id="OldPassword" value="" maxlength="10" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">New Password <span style="color:#F00;">*</span> :</label>
                                <div class="col-md-3">
                                    <input type="password" name="NewPassword" id="NewPassword" value="" maxlength="10" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Confirm Password <span style="color:#F00;">*</span> :</label>
                                <div class="col-md-3">
                                    <input type="password" name="ConfirmNewPassword" id="ConfirmNewPassword" value="" maxlength="10" class="form-control">
                                </div>
                            </div>
