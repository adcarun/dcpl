  	...
  	$(document).ready(function() {
		...
		rules: { 
			...
			messages: {
				...
				//	lettersonly : "Please enter valid Title",
				},
			},
		});
	});
...
{ 
	$('#'+field).rules('remove','remote');
        ...
        <title>VI Schools | Add / Edit Source</title>
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Add / Edit Source</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="User" onReset="this.Name.focus();" action="add-source-action.php" enctype="multipart/form-data" class="form-horizontal form-box" autocomplete="false">
                    	<input type="hidden" name="Id" value="<?= $_POST['id'] ?>" />
                        <h4 class="form-box-header">Add / Edit Source</h4>
                        
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can Add / Edit Source.</small></li>
                        ...
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="Title" id="Title" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Title'])));?>" maxlength="50" class="form-control" autocomplete="false">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    ...
                                    <?php } ?>
                                    <button type="button" class="btn btn-danger" onClick="document.location='./manage-source.php?I=17'" title="Go back to Manage Source" data-toggle="tooltip"><i class="icon-remove"></i> Go back to Manage Source</button>
                                </div>
                            </div>
                            <!-- END Input Sizes -->
						</div>
