...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VI Schools | Manage Source</title>
            ...
            <div id="inner-container">
                ...
                <form name="frm" method="post">
                    ...
                    <?php 
						$cond=" Where Id != 0 "; 
						if($_POST['srch_Name']!="")
							$cond.=" AND Title like '%".htmlspecialchars(addslashes($_POST['srch_Name']))."%' ";
					...
					//	if($_POST['srch_Email']!="")
						...
						set_management("tbl_source", $cond, "Id", "desc", 15);
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Manage Source</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Row Classes -->
                    <h3 class="page-header">Manage Source</h3>
                    	<h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can Manage Source.</small></li>
                            </ul>
                        </h5>
					...
					<div class="row" style="padding:0 0 10px 0">
                        ...
                        <a href="add-source.php?I=17" class="btn btn-success" style="margin-top:10px; margin-right:10px; float:right;"><i class="icon-plus"></i> Add New Source</a>
                       <div style="width:100%; ">
                    <table class="table table-borderless table-hover" style="margin-top:10px;">
                        <thead>
                            <tr class="danger">
                                ...
                                <th class=""<?php //put_sorting('Name','Name')?>>Title</th>
                        ...
                        <tbody>
							...
							?>
                                    <tr class="<?=$class?>">
                                        ...
                                        <td class="">
                                            <div class="btn-group">
                                            	<!--<a href="javascript:EditRecord('<?= $arrData[$key]['Id'] ?>', './view-source.php?I=3');" data-toggle="tooltip" title="View source" class="btn btn-xs btn-success"><i class="icon-info-sign"></i></a>-->
                                            	<a href="javascript:EditRecord('<?= $arrData[$key]['Id'] ?>', './add-source.php?I=3');" data-toggle="tooltip" title="Edit source" class="btn btn-xs btn-success"><i class="icon-pencil"></i></a>
