...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VI Schools | Manage Company</title>
        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <form name="frm" method="post">
                    ...
                    <?php 
						$cond=" Where Id != 0 and Isdelete != 1";
					
						if($_POST['srch_Company']!="")
							$cond.=" AND Id = '".htmlspecialchars(addslashes($_POST['srch_Company']))."' ";
						
						if($_POST['srch_Status']!="")
							$cond.=" AND CDisplayStatus = '".htmlspecialchars(addslashes($_POST['srch_Status']))."' ";
						...
						set_management("tbl_company", $cond, "RegTime", "desc", 15);
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Manage Company</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Row Classes -->
                    <h3 class="page-header">Manage Company</h3>
                    	<h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can Manage Company.</small></li>
                            </ul>
                        </h5>
					...
					<div class="row" style="padding:0 0 10px 0">
                        ...
                        <select class="select-chosen" name="srch_Company" id="srch_Company">
                            ...
                            <?php 
								...
								$arrCompany=$objCompany->getDatalimited("Id,CName"," ",false);
                        ...
                        <div class="col-md-4">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-success" type="button" onClick="clearSearch(this.form, ['srch_Company','srch_Status']);">Show all</button>
                            </div>
                        </div>
                      </div>     
                     </div>
                            ...
                            {
                            ?>
                            <div class="alert alert-danger"  style="margin-top:110px;">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                        ...
                        <a href="add-company.php?I=5" class="btn btn-success" style="margin-top:10px; margin-right:10px; float:right;"><i class="icon-plus"></i> Add New Company</a>
                       <div style="width:100%; " class="table-responsive">
                    <table class="table table-borderless table-hover" style="margin-top:10px; overflow:auto">
                        <thead>
                            <tr class="danger">
                            	
                                <th class="text-center">No</th>
                                <th class=""<?php put_sorting('CName','Name')?></th>
                                <th class=""<?php put_sorting('CDisplayStatus','Status')?></th>
                                <th class="">Actions</th>
                            </tr>
                        </thead>
                        <tbody><?php 
							...
							?>
                                    <tr class="<?=$class?>">
										...
										?></td>
                                        <td class=""><?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[$key]['CName'])));?></td>
                                        <td class="">
											<?php
											
												if($arrData[$key]['CDisplayStatus']=='Active') 
                                        ...
                                        <td class="">
                                            <div class="btn-group">
                                            	<a href="javascript:EditRecord('<?= $arrData[$key]['Id'] ?>', './view-company.php?I=5');" data-toggle="tooltip" title="View Company" class="btn btn-xs btn-success"><i class="icon-info-sign"></i></a>
                                            	<a href="javascript:EditRecord('<?= $arrData[$key]['Id'] ?>', './add-company.php?I=5');" data-toggle="tooltip" title="Edit Company" class="btn btn-xs btn-success"><i class="icon-pencil"></i></a>
                                                <a href="javascript:DeleteRecordNewImage('<?= $arrData[$key]['Id'] ?>','tbl_company','manage-company.php?I=5','Are you sure, you really want to delete this record ?', './delete_record_company.php','');" data-toggle="tooltip" title="Delete Company" class="btn btn-xs btn-danger"><i class="icon-remove"></i></a> 
                                            </div>
                                        </td>
                                    </tr>
                            <?php
