...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>VI Schools | Campaign Wise Dashboard</title>
        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <form name="frm" method="post">
                    ...
                    <input type="hidden" name="srch_Source" value="" />
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">Campaign Wise Dashboard</a></li>
                    </ul>
                    <!-- END Navigation info -->
                    ...
                    <?php /*?><h3 class="page-header">Manage Enquiry</h3>
                        ...
                        <!-- Mini Price Tables -->
                    <h2 class="page-header text-center">Campaign Wise Dashboard</h2>
					<div class="price-tables">
                        ...
                        <?php
							...
							$objExecutive=new GenericClass("tbl_source");
                            $arrExecutive=$objExecutive->getDatalimited("Id,Title"," where DisplayStatus = 'Active' ",false);
							...
							foreach($arrExecutive as $Executive)
							{
								?>
                                	<div class="plan">
                                        <h3 class="plan-header"><?=ucfirst($Executive['Title'])?></h3>
                                        <ul class="icons-ul">
                                        	<?php
												...
												foreach($ArrSiteCodes as $SiteCodes)
												{
													...
													?>
                                                    	<li>
                                                            <a href="javascript:ViewExecutiveEnquiryDetailsSource('<?=$Executive['Id']?>','<?=$SiteCodes['Id']?>','./manage-enquiry.php?I=4');" data-toggle="tooltip" title="Click to view details">
                                                            	<span class="badge badge-<?=$class?>">
                                                                	<?php
																	if($_SESSION['objLogin']->AccessLevel=="Admin"){
																		$ArrCnt=$objTotalCnt->getDatalimited("COUNT(Id) AS cnt"," WHERE Source = ".$Executive['Id']." AND Status = '".$SiteCodes['Id']."' ",false);
																	}else{
																		$ArrCnt=$objTotalCnt->getDatalimited("COUNT(Id) AS cnt"," WHERE Source = ".$Executive['Id']." AND Status = '".$SiteCodes['Id']."' and AssignedTo='".$_SESSION['objLogin']->Id."' and (Type IS NULL or Type!=38) ",false);
																		//$ArrCnt=$objTotalCnt->getDatalimited("COUNT(Id) AS cnt"," WHERE Source = ".$Executive['Id']." AND Status = '".$SiteCodes['Id']."' and AssignedTo='".$_SESSION['objLogin']->Id."' and Type!=38 ",false);
																	}
                                                                   // $ArrCnt=$objTotalCnt->getDatalimited("COUNT(Id) AS cnt"," WHERE Source = ".$Executive['Id']." AND Status = '".$SiteCodes['Id']."' ",false);
                                        ...
                                        <a href="javascript:ExecutiveEnquiryDetailsSource('<?=$Executive['Id']?>', './manage-enquiry.php?I=4');" class="btn btn-warning"><i class="icon-chevron-right"></i> View Details</a>
                                    </div>
                                <?php
								/*if($i==3)
