        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- Text Inputs -->
                    <form name="frm" method="post" id="Enquiry" onReset="this.Source.focus();" action="add-enquiry-action.php" enctype="multipart/form-data" class="form-horizontal form-box">
                    	<input type="hidden" name="Id" value="<?= $_POST['id'] ?>" />
                       <?php if($_SESSION['objLogin']->AccessLevel=="Admin"){ ?>
						<h4 class="form-box-header">Add/ Edit Enquiry</h4>
                        
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can add and edit Enquiry.</small></li>
                        ...
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here Executive can Add Enquiry.</small></li>
                        ...
                        <div class="form-box-content">
						 <div class="row">
						  ...
						  <div class="col-md-6">	
							<div class="form-group">
                				<div class="row"> 
                                <label class="control-label col-md-4" for="masked_phone">Enq. Date :<span style="color:red">*</span></label>
                                <div class="col-md-8">
                                	<div>
                            			<div class="input-group date input-datepicker" data-date="<?=date('d/m/Y');?>" data-date-format="yyyy-mm-dd">
                                			...
                                			<input type="text" id="RegTime" name="RegTime" value="<?php if($arrData[0]['RegTime']!=''){ echo date('j M Y',strtotime($arrData[0]['RegTime']));}else{ echo date('j F Y'); }?>" class="form-control" <?php if($_SESSION['objLogin']->AccessLevel!="Admin"){ ?>readonly<?php } ?>>
                            			</div>
                            		</div>
                                </div>
</div>
						  ...
						  <div class="col-md-6">	
							...
							<div class="col-md-8">
								<input class="form-control" type="text" id="time" name="EnqTime" value="<?php if($arrData[0]['EnqTime']!=""){ ?><?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['EnqTime']))); }else{ echo date("H:i:s"); }?>" /> 
							</div>
						</div>
						  </div>
						  </div>
						 ...
						 <div class="col-md-6">	
                            ...
                            <div class="form-group">
  							...
  							<div class="row"> 
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select class="form-control select-chosen" name="Course[]" id="Course" multiple>
						  ...
						  <div class="form-group">
   							<div class="row"> 
								<label class="control-label col-md-4" for="masked_phone">Phone :<span style="color:red">*</span></label>
							<div class="col-md-8">
								<input type="text" id="Phone"  name="Phone" class="form-control" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Phone'])));?>" maxlength="10"> 
							</div>
</div>
							</div>
						 </div>
						 ...
						 <div class="col-md-6">
						  <div class="form-group">
   							<div class="row"> 
								<label class="control-label col-md-4" for="masked_phone">WhatsApp Number :</label>
							<div class="col-md-8">
								<input type="text" id="Whatsapp"  name="Whatsapp" class="form-control" value="<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['Whatsapp'])));?>" maxlength="10"> 
							</div>
</div>
							</div>
						 </div>
 ...
 :</label>
						...
						<div class="col-md-6">	
						   ...
						   <div class="col-md-6">	
							...
							<div class="col-md-8">
								<input type="text" id="OtherSource"  name="OtherSource" class="form-control" readonly> 
							</div>
</div>
							</div>
						   </div>
						...
						*/ ?>
                            ...
                            <div class="form-group">
								<div class="row"> 
                                <label class="control-label col-md-4" for="masked_phone">Assigned To :<span style="color:red">*</span></label>
                                <div class="col-md-8">
  ...
  <script>
	...
	function checkval(){
	//	alert("test");
		if($('#Course').val() && $('#Phone').val() && $('#Whatsapp').val()){
			//alert(whatsapp);
			...
			$.ajax({
			type: 'POST',
			url: 'checkduplication.php',
			data: { 'course': course, 'Phone': Phone, 'Whatsapp':Whatsapp },
			success: function(data) {
				//alert(data);
				var dataVal=data.trim();
				var res = dataVal.split("#");				
				for (var i = 0, len = res.length; i < len; i++) {
					var resAgain = res[i].split("-");
					//alert(resAgain);
					//alert(resAgain[0]);
					//alert(resAgain[1]);
					if(resAgain[0]==1){
						alert("Enquiry Added Already For this course with same phone number");
						$("button[type=submit]").attr("disabled", "disabled");
					}else{
						  $("button[type=submit]").removeAttr("disabled");
					}
				}
				//document.getElementById('productActualAmt').innerHTML=res[0].trim();
