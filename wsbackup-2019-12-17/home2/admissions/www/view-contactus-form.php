<?php
	...
	$obj=new GenericClass("vitvll_contactus");
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script src="./js/ajax-check.js"></script>	
 	<script>
        ...
        <title>VI Schools | View Contact us Form</title>
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="javascript:void(0)">View Contact us Form</a></li>
                    </ul>
                    <!-- END Navigation info -->
                    ...
                    <form name="frm" method="post" id="AddPackage" onReset="this.PName.focus();" action="add-package-action.php" enctype="multipart/form-data" class="form-horizontal form-box">
                        ...
                        <h4 class="form-box-header">View Contact us Form</h4>
                        
                        <h5 class="form-box-header">Note :<br>
							<ul class="icons-ul">
                            	<li><i class="icon-li icon-arrow-right text-black"></i><small>Here administrator can View Contact us Form.</small></li>
                            </ul>
                        </h5>
                        <div class="form-box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ContactName'])));?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Email :</label>
                                <div class="col-md-5">
                                    <?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ContactEmail'])));?>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Contact no :</label>
                                <div class="col-md-3">
                                	<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ContactNumber'])));?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3" for="masked_phone">Comments : </span></label>
                                <div class="col-md-3">
                                	<?=htmlspecialchars_decode(htmlspecialchars_decode(stripslashes($arrData[0]['ContactComments'])));?>
                                </div>
                            </div>
                            <div class="form-group">
                          ...
                          <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    <button type="button" class="btn btn-danger" onClick="document.location='./manage-contactus.php?I=2'" title="Go back to Manage Contact Us" data-toggle="tooltip"><i class="icon-remove"></i> Go back to Manage Contact Us</button>
                                </div>
                            </div>
                            <!-- END Input Sizes -->
						</div>
