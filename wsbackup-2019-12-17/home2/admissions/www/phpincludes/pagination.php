    ...
    <table class="table table-borderless" width="100%" align="center" border="0" style="overflow:auto" class="pgntn" >
	  <tr > 
	 ...
	 ?>
		...
		if($i <= $pages ){
				if($i == $page_no ) {
				echo '<a style="text-decoration:none" class="PageActive"><font size=1px color=black><b class="btn btn-danger">'.$i.'&nbsp;</b></font></a>';		
				echo '&nbsp;&nbsp;';
				}else{ 
